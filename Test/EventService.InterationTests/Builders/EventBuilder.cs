...
namespace EventService.IntegrationTests.Builders
{
    public class EventBuilder
    {
        ...
        public EventBuilder()
        {
            ...
            _eventIds = DefaultEventIds();
        }

        public List<Guid> BuildEventIds()
        {
            return _eventIds;
        }
        ...
        public List<Guid> DefaultEventIds()
        {
            var eventIds = new List<Guid>
            {
                new("2d930c2e-0fe2-4a60-9270-b8d94e42b155"),
                new("8e81330b-9d1f-42d7-9f3b-c1dfc24d4324"),
                new("d1cde268-83c3-42d1-88c1-1500cb96380b"),
                new("0a1f4800-3944-4cbe-90f7-7be37ed0ab75"),
                new("ef2a2eaf-62c2-47f9-9e6b-d7d348e232b9"),
                new("6758a3e4-0a7a-4b0f-a2f7-22ff877eeb75"),
                new("ee6d9d3a-4744-4c89-829e-f60b8f7e7915"),
                new("4c6c1c9f-4b99-48a9-9b56-3b2341dd413a"),
                new("4a2ac1ad-a2a6-4bf5-87e8-709558830c74"),
                new("25072824-a09b-45cf-b468-8b98c5fdac07")
            };
            return eventIds;
        }
    }
